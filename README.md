...
- Rule-based plan generation creates planned workouts and structured workout documents through a server route that can assemble and analyze six weeks of recent run history first.
